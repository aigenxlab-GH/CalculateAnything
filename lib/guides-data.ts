...
export const guides: Guide[] = [
  ...
  // ── Guide 13: Best FD Rates India 2026 ───────────────────────────────────
  {
    ...
    title: 'Best FD Rates in India June 2026: Which Bank Gives Maximum Returns?',
    description: 'Compare fixed deposit interest rates across 15+ banks for June 2026 — SBI, HDFC, ICICI, Axis, Unity SFB, Suryoday SFB. Best FD rates for 1, 2, 3 and 5-year tenures with senior citizen rates.',
    publishDate: '2026-05-28',
    updatedDate: '2026-06-22',
    readingTime: 10,
    tags: ['FD', 'Fixed Deposit', 'Interest Rates', 'Savings', 'Best FD Rates 2026'],
    ...
    sections: [
      {
        heading: 'Best FD Rates June 2026 — Bank-wise Comparison',
        content: [
        ...
        callout: { type: 'tip', text: 'DICGC Insurance: All bank FDs are insured up to ₹5 lakh per depositor per bank. SFBs are equally covered. Split your corpus across banks if investing above ₹5L to maintain full insurance.' },
      },
      {
        heading: 'Best FD Rates by Tenure (June 2026)',
        content: [
      ...
      {
        heading: 'Senior Citizen FD Rates June 2026 (Extra 0.25–0.75%)',
        content: [
        ...
        callout: { type: 'info', text: 'Senior Citizen Savings Scheme (SCSS): 8.2% interest (government-set, reviewed quarterly), quarterly payout, max ₹30L per depositor. Beats SBI, HDFC, ICICI FD rates for 5-year tenure with zero default risk.' },
      },
      {
        heading: 'How FD Rates Are Decided — and What to Expect',
        content: [
      ...
      {
        heading: 'Tax on FD Interest: The Hidden Cost',
        content: [
        ...
        callout: { type: 'warning', text: 'Tax-saving FD trap: 5-year tax-saving FDs give 80C deduction but the interest earned is still fully taxable at slab rate. If you are in the 30% bracket, your effective post-tax yield on a 7% FD is 4.9%. Compare with PPF (7.1% tax-free) before committing.' },
      },
      {
    ...
    faqs: [
      { q: 'Which bank gives the highest FD interest rate in India in 2026?', a: 'Unity Small Finance Bank offers the highest FD rate at 9.0–9.5% for 1–2 year tenures as of June 2026. Among large banks, Axis Bank and Yes Bank offer the highest rates at 7.5–7.75%. All SFBs are DICGC-insured up to ₹5 lakh, making them safe for amounts within that limit.' },
      { q: 'Are small finance bank FDs safe?', a: 'Yes. All SFBs are regulated by RBI and deposits are covered by DICGC insurance up to ₹5 lakh per depositor per bank — the same as SBI or HDFC Bank. The marginal extra risk (SFBs have smaller balance sheets) is fully covered by insurance for amounts under ₹5L.' },
      { q: 'What is the best FD tenure to invest in June 2026?', a: 'In the current rate-cutting cycle, 2–3 year FDs are optimal. They lock in today\'s higher rates before further RBI cuts bring them down. 1-year FDs expose you to reinvestment risk when rates are lower in 2027.' },
      { q: 'What is the senior citizen FD rate at SBI and HDFC in 2026?', a: 'SBI senior citizen FD rate: 6.75–7.5% (0.25–0.5% above regular rates). HDFC Bank senior citizen FD rate: 7.25–7.65%. For maximum returns, Unity SFB and Suryoday SFB offer 9.5–10.0% for senior citizens on select tenures.' },
      { q: 'Can NRIs invest in FDs in India?', a: 'Yes. NRIs can open NRE FDs (interest is tax-free in India, fully repatriable) or NRO FDs (interest is taxable in India at 30% + surcharge for NRIs). NRE FD rates are similar to domestic FDs and are popular for repatriation needs.' },
      { q: 'How is FD maturity amount calculated?', a: 'For quarterly compounding: Maturity = P × (1 + r/4)^(4×n) where P = principal, r = annual rate (decimal), n = years. Example: ₹1 lakh at 7.5% for 3 years = ₹1,00,000 × (1 + 0.075/4)^12 = ₹1,25,023. Use the [FD Calculator](/calculators/fd-calculator/) for instant results.' },
      { q: 'Can I break FD before maturity?', a: 'Yes, most FDs allow premature withdrawal with a 0.5–1% penalty on the applicable rate. Tax-saving FDs (5-year 80C) have a mandatory lock-in and cannot be broken early. To avoid penalties, use an FD ladder — stagger investments across 3, 6, 12, and 24-month FDs.' },
      { q: 'What is the FD rate at SBI for 1 year, 2 years and 3 years in 2026?', a: 'SBI FD rates June 2026 (indicative): 1 year — 6.8%, 2 years — 7.0%, 3 years — 6.75%, 5 years — 6.5%. Senior citizens get 0.5% extra. SBI offers the Amrit Vrishti scheme at 7.25% for 444-day tenure — worth checking as a special rate option.' },
    ],
