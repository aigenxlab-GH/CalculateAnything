      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{ __html: `(function(){try{
            ...
            var onhome=function(){try{if(location.pathname!=='/')return;var a=JSON.parse(LS.getItem('__dbglog')||'[]');if(a.some(function(r){return /\\/calculators\\//.test(r.from);}))box(a);}catch(e){}};
