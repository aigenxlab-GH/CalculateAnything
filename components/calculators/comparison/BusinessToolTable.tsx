...
const TOOLS: Record<Variant, ToolEntry[]> = {
  ads: [
    ...
    { name: 'SEMrush',      pricing: '$117/mo',       feature: 'Keyword + competitor research',       bestFor: 'SEO + paid keyword discovery',  initials: 'SEM', color: '#ff5722', applyUrl: AFFILIATE.business.adTools.semrush,               socialProof: '10M+ marketing pros' },
    { name: 'Ahrefs',       pricing: '$99/mo',        feature: 'Backlinks + content gap analysis',    bestFor: 'Content marketing strategy',    initials: 'AHR', color: '#0066cc', applyUrl: AFFILIATE.business.adTools.ahrefs,                socialProof: 'Industry SEO gold standard' },
    { name: 'Ubersuggest',  pricing: '$12/mo',        feature: 'Affordable Ahrefs alternative',       bestFor: 'Budget-conscious marketers',    initials: 'UBR', color: '#7c3aed', applyUrl: AFFILIATE.business.adTools.ubersuggest,           socialProof: 'Best value for SMBs' },
  ],
  accounting: [
    ...
    { name: 'Tally Prime',   pricing: '₹675/mo',       feature: 'Industry-standard desktop software',  bestFor: 'Traditional businesses',        initials: 'TLY', color: '#7c3aed', applyUrl: AFFILIATE.business.accounting.tally,               socialProof: '75L+ businesses' },
    { name: 'QuickBooks',    pricing: '₹499/mo',       feature: 'Cloud-based accounting',              bestFor: 'Service businesses',            initials: 'QBK', color: '#2ca01c', applyUrl: AFFILIATE.business.accounting.quickbooks,          socialProof: 'Global accounting leader' },
    { name: 'Vyapar App',    pricing: '₹200/mo',       feature: 'Mobile-first billing for shopkeepers', bestFor: 'Retail + manufacturers',       initials: 'VYP', color: '#f59e0b', applyUrl: AFFILIATE.business.accounting.vyapar,              socialProof: 'Free mobile app' },
    { name: 'Khatabook',     pricing: 'Free + ₹199/mo', feature: 'Digital udhar-bahi for small shops', bestFor: 'Micro businesses',             initials: 'KHA', color: '#16a34a', applyUrl: AFFILIATE.business.accounting.khatabook,           socialProof: '1 Cr+ shopkeepers' },
  ],
  loans: [
    { name: 'Bajaj Finserv',  pricing: '13.50% onwards', feature: 'Loan up to ₹50L · 96-hr disbursal',   bestFor: 'Established SMBs',              initials: 'BAJ', color: '#dc2626', applyUrl: AFFILIATE.business.loans.bajaj,        badge: 'TOP', socialProof: '96-hr disbursal' },
    { name: 'HDFC Bank',      pricing: '15.00% onwards', feature: 'Up to ₹40L · doorstep service',    bestFor: 'Salaried + business owners',    initials: 'HDF', color: '#be185d', applyUrl: AFFILIATE.business.loans.hdfc,                    socialProof: 'Instant sanction letter' },
